...
def picky_piggy(score):
    ...
    if score == 0:
        return 7
    score = ((score - 1) % 6) + 1
    temp = floor(1/7 * (10 ** score)) % 10
    #num = floor((round(1/7, score + 1) * (10 ** score)))
    return temp 
    # END PROBLEM 2
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if score - last_score > high:
            ...
            print(str(high) + " point(s)! That's a record gain for Player " + str(who) + "!")
